        ...
        <ul class="sidebar-menu">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              ...
              <li><a class="" href="<?php echo base_url();?>index.php/kota/tampil_kota">Kota Semarang</a></li>
              <li><a class="" href="<?php echo base_url();?>index.php/kab/tampil_kab">Kab.Semarang</a></li>
              <li><a class="" href="<?php echo base_url();?>index.php/kontak/tampil_kontak">Kontak</a></li>
            </ul>
          </li>
        </ul>
        <!-- sidebar menu end-->
