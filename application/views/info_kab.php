...
<div class="codes">
	<div class="container"> 
		...
		<div class="grid_3 grid_5 w3">
			...
			<center><img class="example-image img-responsive" src="<?php echo base_url().'assets/images/kab_smg/'.$row->foto_utama;?>" width="400" height="400" alt=""/></center>
			<br>
			<div class="well w3l">
				<h4>Deskripsi :</h4>
			...
			<div class="gallery-grids-top">
				<div class="gallery-grids">
					<div class="col-md-4 col-sm-4 col-xs-6 gallery-grid-img hover ehover14"> 
						<a class="example-image-link" href="<?php echo base_url().'assets/images/kab_smg/'.$row->foto1;?>" data-lightbox="example-set" data-title="">
						<img class="example-image img-responsive" src="<?php echo base_url().'assets/images/kab_smg/'.$row->foto1;?>" alt=""/>
							<div class="overlay">
								<h4>Lihat</h4>
							</div> 
						</a> 
					...
					<div class="col-md-4 col-sm-4 col-xs-6 gallery-grid-img hover ehover14">
						<a class="example-image-link" href="<?php echo base_url().'assets/images/kab_smg/'.$row->foto2;?>" data-lightbox="example-set" data-title="">
							<img class="example-image img-responsive" src="<?php echo base_url().'assets/images/kab_smg/'.$row->foto2;?>" alt=""/> 
							<div class="overlay">
								<h4>Lihat</h4>
							</div> 
						</a> 
					...
					<div class="col-md-4 col-sm-4 col-xs-6 gallery-grid-img hover ehover14">
						<a class="example-image-link" href="<?php echo base_url().'assets/images/kab_smg/'.$row->foto3;?>" data-lightbox="example-set" data-title="">
							<img class="example-image img-responsive" src="<?php echo base_url().'assets/images/kab_smg/'.$row->foto3;?>" alt=""/>
							<div class="overlay">
								<h4>Lihat</h4>
							</div> 
						</a>
