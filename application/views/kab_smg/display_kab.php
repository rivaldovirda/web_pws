<section id="main-content">
  <section class="wrapper">
    <div class="row">
      <div class="col-lg-12">
        <h3 class="page-header"><i class="fa fa-table"></i> Kab.Semarang</h3>
      </div>
    </div>
   ...
   <?php endif; ?>
    <div class="row">
      <div class="col-lg-12">
        <section class="panel">
          <a class="btn btn-primary" href="<?php echo base_url();?>index.php/kab/tambah_data"><i class="icon_plus_alt2"></i> Tambah</a>
            ...
            <tbody>
              ...
              ?>
                  <tr>
                    ...
                    <td>
                      <a class="btn btn-success" href="<?php echo base_url('index.php/kab/edit_kab/'.$row['id']);?>"><i class="icon_check_alt2"></i> Edit</a>
                      <a class="btn btn-danger" href="<?php echo base_url('index.php/kab/hapus_kab/'.$row['id']);?>" onClick="return confirm('yakin ingin menghapus ?')"><i class="icon_close_alt2"></i> Hapus</a>
                    </td>
                  </tr>
