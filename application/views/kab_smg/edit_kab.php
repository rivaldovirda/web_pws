  ...
  <section class="panel">
    <div class="panel-body">
      <div class="form">
        ...
        <form class="form-validate form-horizontal" id="feedback_form" method="post" action="<?php echo base_url('index.php/kab/update/'.$id) ?>">
          ...
          <div class="form-group ">
            ...
            <div class="col-lg-10">
              <input class="form-control" id="ctelp" name="telp" type="text" value="<?php echo $telp ?>">
            </div>
          </div>
          <div class="form-group ">
            <label for="cjam" class="control-label col-lg-2">Jam Operasional <span class="required"></span></label>
            <div class="col-lg-10">
              <input class="form-control" id="cjam" name="jam" type="text" value="<?php echo $jam ?>">
            </div>
          </div>
           <div class="form-group ">
            <label for="ctiket" class="control-label col-lg-2">Tiket <span class="required"></span></label>
            <div class="col-lg-10">
              <input class="form-control" id="ctiket" name="tiket" type="text" value="<?php echo $tiket ?>">
            </div>
          </div>
          <div class="form-group ">
